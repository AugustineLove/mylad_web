      ...
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="flex flex-col space-y-4 items-start">
          ...
          <a href="https://play.google.com/store" target="_blank" rel="noopener noreferrer">
            <img className="w-[180px] h-[50px] object-contain hover:scale-105 transition-transform duration-300" src="src/assets/playstore.webp" alt="Download from Playstore" />
          </a>
        </div>
      </div>
